...
YOU_LINK :  process.env.YOU_LINK  === undefined ? 'https://chat.whatsapp.com/GcJ5iJWGa48LU5TEOwknV4' : process.env.YOU_LINK,
OWENR_NO: process.env.OWENR_NO === undefined ? '94715652343' : process.env.OWENR_NO,
...
LOGO: process.env.LOGO === undefined ? `https://i.postimg.cc/TwRcJ3Y8/Mine-20230716-131832.jpg` : process.env.LOGO
};
